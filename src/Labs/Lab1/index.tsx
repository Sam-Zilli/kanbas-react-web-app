    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Pop in microwave till pops are only a second apart.</li>
          <li>Cover with butter.</li>
          <li>Serve and enjoy!</li>
        </ol>
      </div>
      {/*  A1 2.8.2 Unordered List Elements */}
      My favorite recipe:
      ...
      <div id="wd-images">
        ...
        <br />
        <img id="wd-teslabot" alt="image of scary robot thing" src="images/teslabot.jpg" height="200px" />
      </div>
      {/*  A1 2.11 Form Tags */}
      <div id="wd-forms">
        <h4>Form Elements</h4>
      ...
      {/*  A1 2.11.4 File Upload Button */}
      <h5>File upload</h5>
      <input id="wd-upload" type="file" />
      {/*  A1 2.11.5 Radio Buttons */}
      ...
      {/*  A1 2.11.8 Other HTML Field Types */}
      ...
      <a
        id="wd-github"
        href="https://github.com/Sam-Zilli/kanbas-react-web-app.git"
      >
        click here
      </a>
      to see my github repo.
      <br />
    </div>
  );
}
